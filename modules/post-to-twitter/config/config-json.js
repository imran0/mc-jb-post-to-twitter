  ...
  return {
    ...
    arguments: {
      execute: {
        ...
        url: `https://${req.headers.host}/modules/post-to-twitter/execute`,
    ...
    configurationArguments: {
      publish: {
        url: `https://${req.headers.host}/modules/post-to-twitter/publish`
      },
      validate: {
        url: `https://${req.headers.host}/modules/post-to-twitter/validate`
      },
      stop: {
        url: `https://${req.headers.host}/modules/post-to-twitter/stop`
      }
    },
    userInterfaces: {
